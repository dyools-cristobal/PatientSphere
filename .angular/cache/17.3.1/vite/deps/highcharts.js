...
var require_highcharts = __commonJS({
 ...
 - ${i4}: ${e4}`, h2 && (l2 += encodeURI(i4) + "=" + encodeURI(e4));
        ...
        class k {
          ...
          manageEvent(t3) {
            let e3 = x(this.series.options.point, this.options), i3 = e3.events?.[t3];
            g(i3) && (!this.hcEvents?.[t3] || this.hcEvents?.[t3]?.map((t4) => t4.fn).indexOf(i3) === -1) ? (h(this, t3, i3), this.hasImportedEvents = true) : this.hasImportedEvents && !i3 && this.hcEvents?.[t3] && (v(this, t3), delete this.hcEvents[t3], Object.keys(this.hcEvents) || (this.hasImportedEvents = false));
          }
          setState(e3, i3) {
